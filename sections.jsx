      ...
      <div className="container">
        ...
        <div className="vsl-player reveal" style={{'--reveal-delay':'80ms'}} onContextMenu={blockContextMenu}>
          <video
            ref={videoRef}
            className="vsl-video"
            src="https://pub-3d6f0373435d4e6286d54d6fb1209375.r2.dev/VSLSUPERAGENTEFINAL.mp4?v=2"
      ...
      <div className="container">
        <div className="problem-hd problem-hd-split">
          <div className="problem-hd-text">
            ...
            <h2 className="h-display h2 reveal">O mercado virou um camelô de agentes. <em>Você não precisa de 50. Precisa de <span className="accent-word">1</span>.</em></h2>
          </div>
...
/* ───────────── CHECKOUT REDIRECT ─────────────
   Sem modal de captura: todo CTA primário leva direto ao checkout.
   Os botões usam href="#oferta" / "#" como âncora semântica; este
   interceptador global captura o clique e redireciona para t.checkoutUrl. */
...
function Footer({ t }){
  const socials = [
    ...
    {
      label: 'TikTok', href: 'https://www.tiktok.com/@diego.spanevello',
